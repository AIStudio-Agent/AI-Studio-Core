...
const FeatureCard: React.FC<FeatureCardProps> = ({ icon, title, description }) => {
  return (
    <motion.div
      ...
      className="bg-[#F3F4F6] dark:bg-neutral-800 rounded-xl p-6 xl:p-7 shadow-lg transition-all border border-neutral-200 dark:border-neutral-700 cursor-pointer hover:backdrop-blur-md"
    >
      <div
      ...
      <p className="text-base text-neutral-700 dark:text-neutral-300 opacity-90">{description}</p>
    </motion.div>
  );
};
...
const Features: React.FC = () => {
  ...
  return (
    <section id="features" className="relative py-20 bg-white dark:bg-[#1E2117] transition-colors overflow-hidden w-full">
      {/* Background Grid */}
      ...
      <div className="relative z-10 w-full px-4 sm:px-8 md:px-12 lg:px-20 xl:px-24">
        <div className="text-center mb-16">
          <motion.h2
            className="font-['Space_Grotesk'] text-3xl md:text-4xl font-bold text-neutral-900 dark:text-white"
          ...
          <motion.p
            className="text-lg text-neutral-700 dark:text-neutral-300 opacity-90 mt-2"
            initial={{ opacity: 0 }}
