      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10 pt-24">
        <div className="flex flex-col lg:flex-row items-center">
          <div className="lg:w-1/2 lg:pr-12 mb-12 lg:mb-0">
            ...
            <h1 className="font-['Space_Grotesk'] text-4xl md:text-5xl lg:text-6xl font-bold leading-tight text-white mb-6">
              The <span style={{ color: colors.accent[500] }}>AI Marketplace</span> For Next-Gen Solutions
            </h1>
