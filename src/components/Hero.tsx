  ...
  <div className="container mx-auto px-4 md:px-6 relative z-10">
    <div className="flex flex-col lg:flex-row items-start lg:items-center min-h-screen lg:min-h-0">
      ...
      <div className="lg:w-1/2 lg:pr-12 mb-12 lg:mb-0 pt-32 lg:pt-24">
        <h1 className="font-['Space_Grotesk'] text-5xl md:text-6xl lg:text-7xl font-bold leading-tight text-neutral-900 dark:text-white mb-6 min-h-[1.2em]">
          {prefix}
          <span className="text-teal-500">{suffix}</span>
        </h1>

        <p className="text-xl md:text-2xl text-neutral-700 dark:text-neutral-100 mb-8 max-w-lg opacity-90">
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          ...
          <Link
            to="/browse-models"
            className="px-8 py-4 rounded-lg text-lg font-medium border flex items-center justify-center backdrop-blur-sm transition-all 
